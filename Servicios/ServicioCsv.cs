...
public class ServicioCsv
{
    ...
    private string GetFilePart(string fullPath)
    {
        try
        {
            if (string.IsNullOrWhiteSpace(fullPath))
